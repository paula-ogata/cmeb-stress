...
public class PlotActivity extends AppCompatActivity {
     ...
     * It also establish a baseLine (all points equals to 0) also to be plotted and help the
     * analyses of the ECG plot.
     ...
     * @throws IOException class for exceptions thrown while accessing information using streams,
    ...
    public void PlotValues() throws InterruptedException {
        ...
        XYSeries seriesBL = new SimpleXYSeries(xTime, baseLine, "BaseLine");
